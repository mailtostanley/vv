...
class MainWindow(QtGui.QMainWindow):
    ...
    def initCentral(self):
        """初始化中心区域"""
        widgetStrategyM, dockStrategyM = self.createDock(StrategyMonitor, u'策略', QtCore.Qt.RightDockWidgetArea)
        ...
        self.tabifyDockWidget(dockStrategyM, dockOrderM)        
